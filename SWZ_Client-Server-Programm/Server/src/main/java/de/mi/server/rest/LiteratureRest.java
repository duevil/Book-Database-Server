...
public class LiteratureRest {
    ...
    private static final Logger LOGGER = LogManager.getLogger(LiteratureRest.class);
    ...
    public Response getSubfields() {
        LOGGER.info("GET '/subfields' request received");
    ...
    public Response queryBooks() {
        ...
        return ResponseFactory.create(LiteratureQuery::queryBooks);
    }
    ...
    public Response queryBooks(BookFilter filter) {
        ...
        LOGGER.debug("POST '/books' request received with filter {}", filter);
        return ResponseFactory.<Set<Book>, BookFilter>create(LiteratureQuery::queryBooks, filter);
    }
    ...
    public Response updateBook(@HeaderParam(AUTHORIZATION) ClientType type, Book book) {
        ...
        LOGGER.debug("PUT '/update' request received with book {} and type {}", book, type);
    ...
    public Response createBook(@HeaderParam(AUTHORIZATION) ClientType type, Book book) {
        ...
        LOGGER.debug("POST '/create' request received with book {} and type {}", book, type);
        return type.isMaster()
    ...
    public Response deleteBook(@HeaderParam(AUTHORIZATION) ClientType type, @QueryParam("id") int id) {
        ...
        LOGGER.debug("DELETE '/delete' request received with id {} and type {}", id, type);
        return type.isMaster()
