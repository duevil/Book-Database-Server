...
class BookProperties {
    private static final Logger LOGGER = LogManager.getLogger(BookProperties.class);
    ...
    public void set(Book book) {
        LOGGER.debug("Setting book properties to {}", book);
     ...
     */
    public void clear() {
        LOGGER.debug("Clearing book properties");
